...
export default function ProblemStatementReact() {
	...
	const statements =
		activeTab === "current" ? currentStatements : pastStatements;
				...
				{statements.length > 1 && (
					<>
						<button
							...
							className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 z-20 bg-white/90 hover:bg-white text-gray-800 rounded-full p-3 shadow-lg transition-all duration-300 cursor-pointer"
						...
						<button
							...
							className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 z-20 bg-white/90 hover:bg-white text-gray-800 rounded-full p-3 shadow-lg transition-all duration-300 cursor-pointer"
	...
	return (
		<section className="problem-statement-section pb-32 lg:pb-8">
